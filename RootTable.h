...
private:
	...
	void _SearchOverlappedObject(HNode *Node, double *key, set<HNode*>* visited, set<int>* object, int currentTime);
	void _SearchIncludedObject(HNode *Node, double *key, set<HNode*>* visited, set<int>* object, int currentTime);
